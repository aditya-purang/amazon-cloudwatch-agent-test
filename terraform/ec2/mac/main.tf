...
resource "null_resource" "integration_test" {
  ...
  provisioner "remote-exec" {
    inline = [
      ...
      "./validator --validator-config=./test/feature/mac/appParameters.yml --preparation-mode=true",
      "./validator --validator-config=./test/feature/mac/appParametersFinal.yml --preparation-mode=false",
